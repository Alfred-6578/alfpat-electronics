...
const shopLinks = [
  ...
  { label: "Fans & Speakers", href: "/products?category=fans" },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-3">
              ...
              <span className="w-px h-5 bg-[#F97316]" />
              <span className="text-[9px] font-medium tracking-[0.25em] uppercase text-[#0B1B3A]">
                Electronics
              </span>
            </Link>
            <p className="text-sm text-gray-400 max-w-xs leading-relaxed mb-5">
              Quality Electronics for Every Nigerian Home
            </p>
            <div className="flex items-center gap-2">
              {/* Facebook */}
              <button className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 hover:text-[#F97316] hover:border-[#F97316] transition-colors">
          ...
          {/* Shop */}
          <div>
            <h4 className="text-xs font-bold text-[#0B1B3A] uppercase tracking-wider mb-4">
              Shop
            </h4>
      ...
      <div className="border-t border-gray-100 bg-[#F8F9FA]">
        <div className="max-w-7xl mx-auto px-4 lg:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-gray-400">
            © 2025 ALFPAT ELECTRONICS. All rights reserved.
          </p>
          <p className="text-xs text-gray-400">
